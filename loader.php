	...
	class teleporter_loader {
		...
		public function readme_viewer() {
			...
			if ( file_exists( $parser ) ) {
				...
				$readme = new teleporter_readme_parser();
...
add_action( 'plugins_loaded', 'teleporter_load_prefixed_functions', 0 );

if ( !function_exists( 'teleporter_load_prefixed_functions' ) ) {
	function teleporter_load_prefixed_functions() {
		...
		if ( !function_exists( 'teleporter_get_namespace_from_function' ) ) {
			function teleporter_get_namespace_from_function( $f ) {
		...
		if ( !function_exists( 'teleporter_loader_instance' ) ) {
			function teleporter_loader_instance() {
		...
		if ( !function_exists( 'teleporter_freemius_instance' ) ) {
			function teleporter_freemius_instance() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'teleporter_plugin_data' ) ) {
			function teleporter_plugin_data() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
		...
		if ( !function_exists( 'teleporter_plugin_version' ) ) {
			function teleporter_plugin_version() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Set Pro Namespace
		// -----------------
		if ( !function_exists( 'teleporter_pro_namespace' ) ) {
			function teleporter_pro_namespace( $pronamespace ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Add Settings
		// ------------
		if ( !function_exists( 'teleporter_add_settings' ) ) {
			function teleporter_add_settings() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Defaults
		// ------------
		if ( !function_exists( 'teleporter_default_settings' ) ) {
			function teleporter_default_settings( $key = false ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Options
		// -----------
		if ( !function_exists( 'teleporter_get_options' ) ) {
			function teleporter_get_options() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Get Setting
		// -----------
		if ( !function_exists( 'teleporter_get_setting' ) ) {
			function teleporter_get_setting( $key, $filter = true ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'teleporter_get_settings' ) ) {
			function teleporter_get_settings( $filter = true ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Reset Settings
		// --------------
		if ( !function_exists( 'teleporter_reset_settings' ) ) {
			function teleporter_reset_settings() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Update Settings
		// ---------------
		if ( !function_exists( 'teleporter_update_settings' ) ) {
			function teleporter_update_settings() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Delete Settings
		// ---------------
		if ( !function_exists( 'teleporter_delete_settings' ) ) {
			function teleporter_delete_settings() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Message Box
		// -----------
		if ( !function_exists( 'teleporter_message_box' ) ) {
			function teleporter_message_box( $message, $echo = false ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Header
		// ---------------
		if ( !function_exists( 'teleporter_settings_header' ) ) {
			function teleporter_settings_header() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		// Settings Page
		// -------------
		if ( !function_exists( 'teleporter_settings_page' ) ) {
			function teleporter_settings_page() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'teleporter_settings_table' ) ) {
			function teleporter_settings_table() {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
		...
		if ( !function_exists( 'teleporter_settings_resources' ) ) {
			function teleporter_settings_resources( $media, $color_picker ) {
				$namespace = teleporter_get_namespace_from_function( __FUNCTION__ );
				$instance = $GLOBALS[$namespace . '_instance'];
