...
= 1.1.5 =
* Added: touchscreen ignore link classes (eg. for mobile menus)

= 1.1.4 =
* Update: Plugin Panel (1.3.8) - set options on construct
* Fixed: double pushstate bug affecting back/forth navigation
